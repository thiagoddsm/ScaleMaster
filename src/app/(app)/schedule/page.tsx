    ...
    <div className="space-y-8">
      <div>
        ...
        <p className="text-muted-foreground">
          Gere novas escalas de voluntários ou visualize as que já foram salvas.
        </p>
      </div>
            ...
            <CardHeader>
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <CardDescription>Crie uma nova escala automatizada com base nos voluntários e eventos.</CardDescription>
                </div>
              </div>
            </CardHeader>
            <CardContent>
              <p className="text-sm text-muted-foreground">
                Selecione os parâmetros, como período e áreas, e deixe a IA fazer o trabalho pesado de alocação.
              </p>
            </CardContent>
          </Card>
        </Link>
            ...
            <CardHeader>
               <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <CardDescription>Consulte, edite ou exporte as escalas que foram geradas anteriormente.</CardDescription>
                </div>
              </div>
            </CardHeader>
            <CardContent>
