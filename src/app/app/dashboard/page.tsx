        ...
        <Card className="flex flex-col">
          ...
          <CardFooter className="flex flex-wrap gap-2">
            <Button asChild variant="secondary">
              <Link href="/app/volunteers">Gerenciar Voluntários</Link>
            </Button>
            <Button asChild variant="secondary">
              <Link href="/app/events">Gerenciar Eventos</Link>
            </Button>
            <Button asChild variant="secondary">
              <Link href="/app/areas">Gerenciar Áreas</Link>
            </Button>
             <Button asChild variant="secondary">
              <Link href="/app/teams">Gerenciar Equipes</Link>
            </Button>
          </CardFooter>
        </Card>
      </div>
