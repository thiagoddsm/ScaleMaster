...
export const events: Event[] = [
  {
    ...
    dayOfWeek: 'Domingo',
    time: '07:30',
    areas: ['Som', 'Projeção', 'Recepção', 'Apoio', 'Security', 'Saúde'],
  ...
  },
  {
    ...
    dayOfWeek: 'Domingo',
    time: '10:00',
    areas: ['Som', 'Projeção', 'Iluminação', 'Broadcasting', 'Recepção', 'Musikids', 'Security', 'Saúde', 'Apoio', 'Estacionamento', 'Fotografia'],
    responsible: 'Pastor Jonas',
  },
  {
    id: '3',
    ...
    dayOfWeek: 'Domingo',
    time: '17:30',
    areas: ['Som', 'Projeção', 'Iluminação', 'Broadcasting', 'Recepção', 'Apoio', 'Security'],
  ...
  },
  {
    ...
    time: '20:00',
    areas: ['Som', 'Projeção', 'Recepção', 'Apoio'],
