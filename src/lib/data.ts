...
export const events: Event[] = [
  {
    ...
    dayOfWeek: 'Domingo',
    time: '10:00',
    areas: ['Som', 'Tecnologia', 'Louvor', 'Recepção', 'Kids'],
  ...
  },
  {
    ...
    date: '2024-08-11',
    time: '18:00',
    areas: ['Som', 'Tecnologia', 'Louvor', 'Recepção', 'Kids', 'Limpeza'],
    responsible: 'Pastor Jonas',
